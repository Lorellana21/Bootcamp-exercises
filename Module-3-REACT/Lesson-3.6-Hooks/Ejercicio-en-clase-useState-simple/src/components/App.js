...
const App = () => {
  ...
  const handleCity = (ev) => {
    ...
    setAddress({
      country: address.country, //aqio mantiene country tal y como estaba
      city: ev.target.value,
    });

    // opción 3: la mejor de las tres. Los 3 puntos es el "spread", coge todo lo que yo tenia y solo va a ctualizar city:
    // setAddress({
    //   ...address,
    //   city: ev.target.value,
    // });
    ...
    <div>
      ...
      <form>
        ...
        <input
          ...
          type="text"
          id="city"
          onChange={handleCity} //con esta funcion solo quiero manejar ele stadod e la ciudad, no del pais
        />
      </form>
